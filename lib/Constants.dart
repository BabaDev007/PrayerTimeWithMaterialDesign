...
class Constants{
  ...
  var backdropColor = Colors.lightBlueAccent.shade400.withOpacity(0.2);
  var aboveWidgetColor = Colors.blue.shade300;
  String aboveWidgetImageAsset = "assets/pngwing.com.png";
  var borderRadius = BorderRadius.circular(20);
  String dialogHomeScreen = "Tətbiq Ömər Babayev tərəfindən hazırlanmışdır";
  var scaffolColor = Colors.blue.shade100;
